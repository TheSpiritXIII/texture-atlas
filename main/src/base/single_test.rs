...
fn missing_bin() {
	let mut atlas =
		SingleAtlas::<_, IndexedBin<Pos2>, _>::new(new_options(), AlwaysExistingBinPacker);
...
#[test]
fn packer_error() {
	let mut atlas = SingleAtlas::<_, IndexedBin<Pos2>, _>::new(new_options(), AlwaysErrorPacker);
